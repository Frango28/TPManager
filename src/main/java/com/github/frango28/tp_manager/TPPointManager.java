...
import com.github.frango28.tp_manager.util.ConfigLoader;
...
public class TPPointManager {
    ...
    public void addMap(@NotNull TeleportPoint point) {
        ...
        if(hasData(point.getName())){throw new IllegalArgumentException();}
    ...
    public void removeMap(String name) {
        ...
        tp.ifPresent(point->this.tpPointSet.remove(point));
    }
